let playlist = [ {
    ...
    'audio': "media/01. 3D (feat. Jack Harlow).mp3",
  }, {
    'title': 'Closer to You (Feat. Major Lazer)',
    'audio': "media/02. Closer to You (feat. Major Lazer).mp3",
  }, {
    'title': 'Seven (feat. Latto) (Explicit Ver.)',
    'audio': "media/03. Seven (feat. Latto) (Explicit Ver.).mp3",
  },
     {
    'title': 'Standing Next to You',
    'audio': "media/04. Standing Next to You.mp3",
  },
     {
    'title': 'Yes or No',
    'audio': "05. Yes or No.mp3",
  },
  {
    'title': 'Please Dont Change (feat. DJ Snake)',
    'audio': "media/06. Please Don't Change (feat. DJ Snake).mp3",
  },
  {
    'title': 'Hate You',
    'audio': "media/07. Hate You.mp3",
  },
  {
    'title': 'Somebody',
    'audio': "media/08. Somebody.mp3",
  },
  {
    'title': 'Too Sad to Dance',
    'audio': "media/09. Too Sad to Dance.mp3",
  },
  {
    'title': 'Shot Glass of Tears',
    'audio': "media/10. Shot Glass of Tears.mp3",
  },
  {
    'title': 'Seven (feat. Latto) (Clean Ver.)',
    'audio': "media/11. Seven (feat. Latto) (Clean Ver.).mp3",
  }
];
  i = 0;
  n = playlist.length;
